...
public class DVFS {
    ...
    private static double vmsNumber = 3;
    private static double cloudletsNumber = 220;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.print("Tareas enviados a broker -->"+cloudletList.size());
    ...
    private static List<Cloudlet> createCloudletList(int brokerId) {
        ...
        System.out.print("NUMERO DE TAREAS --->"+list.size());
        return list;
    }
    ...
    private static List<Vm> createVms(int brokerId) {
        ...
        int pesNumber = 3; // number of cpus
    ...
    private static PowerDatacenter createDatacenter(String name) throws Exception {
        ...
        double staticPowerPercent = 0.8; // 70%
